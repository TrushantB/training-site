...
<svg version="1.1" id="home-anim" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<g id="home">
    ...
    <div class="cover">
  <div class="logo">
    <a href="https://www.ivisionstudio.in" target="_blank">
      <img class="logo" src="//images.ctfassets.net/frm2ukqlqqti/4rHqSD4WvlNuwkqyjWvNOy/d4d3579f6939de45be966d11ecdc1e36/ivision_logo.png" alt="SourJelly"/>
    </a>
    <p class="text">
      iVision Training Institute is an independent Pune based Computer Training Institute specialized in UI/UX Development, Mobile Apps development, MEAN Stack Developement, Architectural Design, Engineering Design & Programming Languages.
For more information, please contact us at
    </p>
    <a href="mailto:contact@ivisionstudio.in" class="btn btn-lg d-inline-block mt-30">contact@ivisionstudio.in</a>
  </div>
</div>
